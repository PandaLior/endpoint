...
# Core Endpoint - Remaining 5 pages (cloud, threat-intel, vulnerability, zero-trust, index)

UNIQUE_PAGES['services/core-endpoint/cloud.html'] = {
    'title': 'Cloud Endpoint Security - EndPointUS',
    'desc': 'Cloud-delivered endpoint security providing consistent protection for remote workforces through cloud-native architecture with secure web gateways and cloud access security brokers.',
    'intro': 'Cloud-delivered endpoint security providing consistent protection for remote workforces, branch offices, and mobile users through cloud-native architecture with secure web gateways, cloud access security brokers, and zero trust network access.',
    ...
    'related': ['/services/core-endpoint/zero-trust.html', '/services/bcdr/cloud-backup.html', '/resources/best-practices/remote-work-security.html']
}

UNIQUE_PAGES['services/core-endpoint/threat-intel.html'] = {
    'title': 'Threat Intelligence Integration - EndPointUS',
    'desc': 'Strategic and tactical threat intelligence integration providing actionable insights on adversary tactics, techniques, procedures, and indicators enabling proactive defense.',
    'intro': 'Strategic and tactical threat intelligence integration providing actionable insights on adversary tactics, techniques, procedures, and indicators of compromise enabling proactive defense and informed security decisions.',
    ...
    'related': ['/services/managed-operations/threat-hunting.html', '/resources/threat-intelligence/', '/services/core-endpoint/edr.html']
}

UNIQUE_PAGES['services/core-endpoint/vulnerability.html'] = {
    'title': 'Vulnerability Management - EndPointUS',
    'desc': 'Continuous vulnerability management identifying, prioritizing, and remediating security weaknesses across endpoints through automated scanning, risk-based prioritization, and coordinated patch management.',
    'intro': 'Continuous vulnerability management identifying, prioritizing, and remediating security weaknesses across endpoints through automated scanning, risk-based prioritization, and coordinated patch management ensuring comprehensive vulnerability coverage.',
    ...
    'related': ['/services/testing/vulnerability-assessment.html', '/services/testing/endpoint-scanning.html', '/services/managed-operations/24x7-monitoring.html']
}

UNIQUE_PAGES['services/core-endpoint/zero-trust.html'] = {
    'title': 'Zero Trust Security Architecture - EndPointUS',
    'desc': 'Zero trust implementation eliminating implicit trust through identity verification, device posture checking, microsegmentation, and continuous authentication enforcing least-privilege access.',
    ...
    'related': ['/services/core-endpoint/cloud.html', '/services/managed-operations/siem.html', '/compliance/general/nist.html']
}

UNIQUE_PAGES['services/core-endpoint/index.html'] = {
    'title': 'Core Endpoint Security Services - EndPointUS',
    'desc': 'Comprehensive endpoint security combining detection, prevention, and response capabilities protecting desktops, laptops, servers, and mobile devices against modern cyber threats.',
    'intro': 'Comprehensive endpoint security combining detection, prevention, and response capabilities protecting desktops, laptops, servers, and mobile devices against modern cyber threats through integrated multi-layered protection.',
    ...
    'related': ['/services/core-endpoint/edr.html', '/services/core-endpoint/epp.html', '/services/managed-operations/mdr.html']
}
...
UNIQUE_PAGES['services/threat-protection/index.html'] = {
    'title': 'Threat Protection Services - EndPointUS',
    'desc': 'Specialized threat protection services defending against specific attack types including ransomware, malware, phishing, APTs, fileless threats, and insider risks.',
    ...
    'related': ['/services/managed-operations/mdr.html', '/services/core-endpoint/edr.html', '/services/managed-operations/incident-response.html']
}

UNIQUE_PAGES['services/threat-protection/malware-removal.html'] = {
    'title': 'Malware Removal Services - EndPointUS',
    'desc': 'Professional malware removal and remediation services completely eradicating infections through multi-layered scanning, manual analysis, and persistence elimination.',
    ...
    'related': ['/services/threat-protection/ransomware.html', '/services/managed-operations/incident-response.html', '/services/core-endpoint/edr.html']
}

UNIQUE_PAGES['services/threat-protection/ransomware.html'] = {
    'title': 'Ransomware Protection - EndPointUS',
    'desc': 'Multi-layered ransomware defense combining behavioral detection, automated containment, backup protection, and incident response preventing encryption.',
    ...
    'related': ['/services/bcdr/ransomware-recovery.html', '/services/bcdr/cloud-backup.html', '/services/managed-operations/incident-response.html']
}

UNIQUE_PAGES['services/threat-protection/phishing.html'] = {
    'title': 'Phishing Protection - EndPointUS',
    'desc': 'Comprehensive anti-phishing protection combining email filtering, link analysis, credential monitoring, user training, and incident response.',
    ...
    'related': ['/services/testing/social-engineering.html', '/services/managed-operations/incident-response.html', '/resources/security-awareness/']
}

UNIQUE_PAGES['services/threat-protection/apt-defense.html'] = {
    'title': 'Advanced Persistent Threat (APT) Defense - EndPointUS',
    'desc': 'Specialized APT defense protecting against nation-state actors and organized cybercrime groups through threat hunting, behavioral analytics, and threat intelligence.',
    ...
    'related': ['/services/managed-operations/threat-hunting.html', '/services/core-endpoint/threat-intel.html', '/services/managed-operations/mdr.html']
}

UNIQUE_PAGES['services/threat-protection/fileless-malware.html'] = {
    'title': 'Fileless Malware Protection - EndPointUS',
    'desc': 'Specialized defense against fileless threats and living-off-the-land attacks using memory scanning, script analysis, and behavioral detection.',
    ...
    'related': ['/services/core-endpoint/edr.html', '/services/managed-operations/threat-hunting.html', '/services/threat-protection/malware-removal.html']
}

UNIQUE_PAGES['services/threat-protection/insider-threat.html'] = {
    'title': 'Insider Threat Detection - EndPointUS',
    'desc': 'Comprehensive insider threat program using user behavior analytics, data loss prevention, privileged access monitoring, and investigation support.',
    ...
    'related': ['/services/bcdr/dlp.html', '/compliance/hipaa/ephi-security.html', '/compliance/financial/pci-dss.html']
}
